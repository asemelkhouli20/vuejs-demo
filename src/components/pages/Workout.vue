...
const { workout, warmup } = workoutProgram[selectWorkout]
...
<template>
      <Portal v-if="selectedExercise">
            <div class="exercise-description">
                  ...
                  <div>
                        <small>Decraption</small>
                        <p>{{ exerciseDescription }}</p>
                  </div>
                  <button @click="() => selectedExercise = null">Close <i class="fa-solid fa-xmark"></i></button>
            </div>
      </Portal>
      <section id="workout-card">
            <div class="plan-card card">
                  <div class="plan-card-header">
                        <p> Day {{ selectWorkout < 9 ? `0${selectWorkout + 1}` : selectWorkout + 1 }}</p>
